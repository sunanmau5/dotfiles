...
alias marta="cd ~/Documents/marta/mono"
...
alias g-clean="git clean -fxd && yarn install && sh scripts/ux-sync.sh && yarn run db:create"
alias m-v="yarn run tsc && yarn run test && yarn run databuilder:tests"
alias m-recreate="marta && sh /Users/mba/Documents/scripts/recreate-db.sh"
